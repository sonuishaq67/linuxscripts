...
then
export DISPLAY=:0.0 
zenity --warning --title="Battery level $ac_power" --width=600 --timeout=10 --text="Please remove the charger"
...
then
export DISPLAY=:0.0 
zenity --warning --title="Battery level $ac_power" --width=600 --timeout=10 --text="Please plug the charger"
